...
int x, y;  // Coordenadas iniciais do jogador (obs: necessário alterar na função "iniciar()" também.


char mapa[H][W]; // Mapa do labirinto

// Função para inicializar o mapa com paredes
...
// Reinicia o mapa gerando um labirinto procedural
...
void menu(usuarios_t **listausuarios) {
    ...
    SetConsoleTitle("Maze Game | Fase 6");
    
    do {
        printf("============== MAZE GAME | FASE 6 ==============\n");
...
void avancarfase(usuarios_t *listausuarios){
    ...
    printf("Avancando para a tela final!\n");
    Sleep(1000);
    salvarEstatisticas(listausuarios);
    system("start ..\\Tela_Final\\telaFinal.exe");
    exit(1);
